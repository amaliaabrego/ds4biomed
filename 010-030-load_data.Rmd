...
If we want to refer to any arbitrary filer or folder on the computer, we can specify the **full path** of the file. -> Had to look up what "arbitary filer" meant but that could've just been my lack of knowledge in this area
The full path will start with a drive letter on windows, -> same here, had to look up "drive letter" but once i did that, I was able to understand what you were talking about
...
Now, if our **working directory** is now located in the `analysis` folder,
